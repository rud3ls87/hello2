...
method.init = function() {
  ...
  log.debug("Medium EMA size"+this.settings.mediumSize);
...
method.log = function() {
  ...
  var mediumEMA = this.talibIndicators.mediumEMA;
  ...
  log.debug('\t mediumEMA :', mediumEMA.result);
...
method.check = function(candle) {
  ...
  var shortResult = this.talibIndicators.mediumEMA.result.outReal;
  ...
  //EMA Golden Cross
  if((shortResult > mediumResult && mediumResult > longResult) >= this.delta) {
  ...
  } else if(mediumResult > shortResult) {
